...
try {
    ...
    Write-Host "`n==> Resolve verified v0.2.5-alpha installer"
    $previousDirectory = Join-Path $tempRoot "PreviousInstaller"
    $previous = Invoke-CheckedStage -StageName "Resolve v0.2.5-alpha installer" -Action {
    ...
    Write-Host "Previous version:  0.2.5-alpha"

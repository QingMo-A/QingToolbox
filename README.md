...
- B1 现为 **Engineering Complete — Frozen**，且仍仅限 Development/ModuleTest。下一步 B2 是 Production 生命周期适配器和 Development-only TextTools 金丝雀；两者尚未开始，Preview 2 未执行人工验收仍为 `Not Run`。

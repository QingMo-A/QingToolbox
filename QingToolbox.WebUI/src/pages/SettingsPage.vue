...
async function toggleLaunchAtLogin() {
  if (!settings.snapshot || hostControlsDisabled.value || !settings.snapshot.canConfigureLaunchAtLogin || settings.launchAtLoginBusy) return

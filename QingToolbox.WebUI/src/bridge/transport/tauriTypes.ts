...
export type SettingsSnapshot = { language: string; appearancePresetId: string; closeBehavior: string; startupPresentation: string; toggleHotkey: string; launchAtLogin: boolean; showLogsInSidebar: boolean; recentModuleIds: string[]; settingsSchemaVersion: number }

...
export interface PingResponse { pong:true; hostTime:string }
...
export function isPingResponse(value:unknown):value is PingResponse{return isRecord(value)&&value.pong===true&&validDate(value.hostTime)}

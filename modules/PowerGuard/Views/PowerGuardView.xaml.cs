...
public partial class PowerGuardView : UserControl, ILocalizedModuleView, IDisposable
{
    ...
    private async void Test_Click(object s,RoutedEventArgs e){try{await _viewModel.TestAsync();}catch{StatusText.Text=T("errors.operationFailed","Operation failed.");}}

...
本文说明 QingToolbox `0.2.3-alpha` 的安装器唯一 Release Candidate 构建与人工发布交接流程。

0.2.3-alpha RC 必须使用经过官方 SHA256 sidecar 验证的 `v0.2.2-alpha` 安装器，
...
`v0.2.2-alpha → 0.2.3-alpha` 升级测试会启动 Production 模式的旧宿主。Windows Known Folder 不能通过修改
